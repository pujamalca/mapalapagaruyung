                        ...
                        <a href="{{ route('gallery.show', $gallery) }}"
                           class="group block bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow border border-gray-200">
                            ...
                            @php
                                ...
                                $firstImage = $gallery->getFirstMediaUrl('images');
                                $imageUrl = $cover ?: $firstImage;
                            @endphp

                            <div class="aspect-video relative overflow-hidden bg-gradient-to-br from-purple-400 to-indigo-500">
                                @if($imageUrl)
                                    <img src="{{ $imageUrl }}"
                                         alt="{{ $gallery->title }}"
